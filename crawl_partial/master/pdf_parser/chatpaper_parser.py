...
if __name__ == "__main__":
    ...
    trg_dir_path = org_dir_path.with_name("chatpaper_parser_results")
    ...
    for pdf_file in tqdm(org_dir_path.glob("*.pdf")):
        ...
        try:
            ...
            with open(trg_path, "w") as f:
                json.dump(paper.section_text_dict, f)
        except Exception as e:
            error_log[str(pdf_file.name)] = str(e)
            continue

    error_log_path = trg_dir_path.with_name("error_log_chatpaper.json")
